...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input type="text" class="form-control" name="apellidop" id="apellidop" placeholder="Apellido Paterno" maxlength="30">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Segundo Apellido:</label>
      <input type="text" class="form-control" name="apellidom" id="apellidom" placeholder="Apellido Materno" maxlength="30">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
